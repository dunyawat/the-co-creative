<template>
    ...
    <div class="container">
         ...
         <div class="row m-0">
            <div class="col-6 p-0">
                <div class="form-group mb-3">
                    ...
                    <input class="form-control input-b" required type="text" name="projectName" id="projectName" v-model="projectName">
                </div>
            </div>
        </div>
         <div class="row m-0">
        ...
        <div class="row m-0">
            <div class="col-6 p-0">
                <div class="form-group mb-3">
                    ...
                    <input type="file" class="form-control input-b mb-3" @change="readFileMain($event)">
        ...
        <div class="row m-0 border-b">
            <div class="col-6 p-0">
                <div class="form-group mb-3">
                    ...
                    <input type="file" class="form-control input-b mb-3" @change="readFileDisplay($event)">
        ...
        <div class="mb-5">
            <button class="btn confirm-btn px-5" v-if="id == 'add'" @click="createProject">ADD</button>
            <button class="btn confirm-btn px-5" v-else @click="updateProject">SAVE</button>
        </div>
    </div>
</template>
...
<script>
    ...
    import { MDBIcon,MDBDropdown, MDBDropdownToggle, MDBDropdownMenu, MDBDropdownItem  } from 'mdb-vue-ui-kit';
    import {
        PUSH_PROJECT,
        GETTER_PROJECT,
        PUSH_TAGS,
